;******************************************************************************
;
;                   INTERRUPT VECTORS   для uC/OC-II
;                     ARM
;                   KEIL's uVision3 
...
;******************************************************************************
      ...
      PRESERVE8
      AREA   VECT, CODE, READONLY   ; Name this block of code - слово AREA задает начало "секции" кода 
      THUMB
...
;******************************************************************************
;                      INITIALIZE EXCEPTION VECTORS  ; Таблица векторов, где она будет расположена?
;******************************************************************************
