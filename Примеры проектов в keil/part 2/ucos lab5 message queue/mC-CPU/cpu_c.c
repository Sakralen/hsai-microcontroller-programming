...
*                           1       Invalid (see Note #1b)  (APN)
*                           2       Non-maskable interrupt.
*                           3       Hard Fault.
*                           4       Memory Management.
*                           5       Bus Fault.
*                           6       Usage Fault.
*                           7-10    Reserved (Note #1c)
*                           11      SVCall
*                           12      Debug monitor.
*                           13      Reserved (Note #1c)
*                           14      PendSV.
...
*
*                   (a) Position 0 points to the top of stack 
*                   (b) Position 1 is start addr after RESET (APN)
*                   (с) Positions 7-10, 13 are reserved  (APN)
*
