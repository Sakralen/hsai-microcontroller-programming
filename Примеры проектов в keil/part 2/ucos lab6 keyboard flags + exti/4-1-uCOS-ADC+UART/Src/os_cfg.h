...
#define OS_EVENT_NAME_SIZE        0u    /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
...
#define OS_TASK_NAME_EN           0    /*     Enable (1) or Disable (0) code generation for NAME       */
...
#define OS_TASK_REG_TBL_SIZE      0    /*     TASK_REG_TBL_SIZE must be <=255                          */
...
#ifndef KB_FLAGS_ONLY_CFG
	#define OS_FLAGS_NBITS          8    /* Size in #bits of OS_FLAGS data type (8, 16 or 32)            */
#else 
	#define OS_FLAGS_NBITS          16
#endif

#define OS_FLAG_NAME_EN           0    /* Enable (1) or Disable (0) code generation for NAME (APN)     */
...
#define OS_MEM_NAME_EN            0    /* Enable (1) or Disable (0) code generation for NAME    */
...
#define OS_TMR_CFG_MAX            0    /*     Maximum number of timers                                 */
#define OS_TMR_CFG_NAME_SIZE      0    /*     Determine the size of a timer name                       */
#define OS_TMR_CFG_WHEEL_SIZE     0    /*     Size of timer wheel (#Spokes)                            */
#define OS_TMR_CFG_TICKS_PER_SEC 	0   /*     Rate at which timer management task runs (Hz)            */
#define OS_TMR_CFG_NAME_EN        0    /* Enable (1) or Disable (0) NAME for TIMERS                    */
