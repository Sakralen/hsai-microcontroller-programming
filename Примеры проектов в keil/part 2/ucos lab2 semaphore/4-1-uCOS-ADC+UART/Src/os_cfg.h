...
#define OS_EVENT_NAME_SIZE        2u    /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
...
#define OS_MEM_NAME_EN            1    /* Enable (1) or Disable (0) code generation for NAME    */
...
#define OS_TMR_CFG_WHEEL_SIZE     4    /*     Size of timer wheel (#Spokes)                            */
